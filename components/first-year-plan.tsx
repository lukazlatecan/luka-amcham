  ...
  return (
    <motion.div variants={blockVariants} className="relative flex gap-8">
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div
          ...
          style={{
            ...
            boxShadow: "0 0 24px rgba(79,207,192,0.5), 0 0 60px rgba(79,207,192,0.2)",
          }}
        >
          {step}
        </div>
      ...
      <div className="flex-1 pb-12">
        <div className="mb-3 text-xs font-semibold uppercase tracking-[0.2em] text-teal">
          {label}
        </div>
        <div className="rounded-xl border border-border bg-surface p-6" style={{ borderLeft: "3px solid rgba(79,207,192,0.3)" }}>
          {children}
        </div>
      </div>
    </motion.div>
    ...
    >
      <div className="mx-auto max-w-4xl">
        ...
        <motion.div
          ...
          className="mb-20"
        >
          <div className="mb-4 inline-block rounded-full border border-coral/25 bg-coral/10 px-4 py-1.5 text-xs font-medium uppercase tracking-[0.2em] text-coral">
            Roadmap
          </div>
        ...
        >
          ...
          <Step step={3} label={t.plan.impact.label[locale]} isLast>
            <ul className="flex flex-col gap-3">
              {(t.plan.impact.items[locale] as readonly string[]).map((item, i) => (
