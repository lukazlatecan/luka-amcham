...
export function HowILead() {
  ...
  const body1 =
    locale === "en"
      ...
      : "Javno nastopanje je bil eden mojih največjih izzivov izven cone udobja. Vedno sem gradil stvari za zasloni in pustil, da delo govori samo zase. Stati pred občinstvom in prevzeti nadzor nad prostorom se je zdelo povsem drugačna veščina."
  const body2 =
    locale === "en"
