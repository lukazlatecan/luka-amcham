          ...
          <div className="relative overflow-hidden">
            <AnimatePresence mode="wait" custom={direction}>
              <motion.div
                ...
                style={{
                  background: "linear-gradient(135deg, rgba(240,76,92,0.04) 0%, rgba(79,207,192,0.04) 100%)",
                  borderLeft: "3px solid rgba(240,76,92,0.4)",
                }}
              >
                {/* quote mark */}
                <div className="mb-5">
                  <svg width="48" height="40" viewBox="0 0 48 40" fill="none" className="text-indigo opacity-40">
                    <path d="M0 40V24C0 17.2 1.6 11.5 4.8 6.8C8.1 2.1 12.8 0 18 0l2.4 4.3C15.8 5.5 12.4 7.9 10.2 11.4C8 14.9 6.9 18.9 6.9 23.4H14.4V40H0ZM27.6 40V24C27.6 17.2 29.2 11.5 32.4 6.8C35.7 2.1 40.4 0 45.6 0L48 4.3C43.4 5.5 40 7.9 37.8 11.4C35.6 14.9 34.5 18.9 34.5 23.4H42V40H27.6Z" fill="currentColor" />
                  </svg>
                </div>
                ...
                <div className="flex items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex flex-col">
                      <span className="text-sm font-semibold text-text">{item.author[locale]}</span>
                      {item.role[locale] && (
                  ...
                  <a
                    href={item.pdfUrl}
                    download
                    className="inline-flex shrink-0 items-center gap-2 rounded-xl border border-indigo/25 bg-indigo/8 px-4 py-2 text-xs font-medium text-indigo transition-all hover:bg-indigo/15 hover:scale-[1.02]"
                  >
