...
export function CoreNarrative() {
  ...
  const titleEn = (
    <>
      ...
      <span
        className="text-teal"
        style={{ textShadow: "0 0 40px rgba(79,207,192,0.4)" }}
      >
        make complexity
      </span>{" "}
      work.
  ...
  return (
    <section id="journey" ref={ref} className="w-full py-14">
      <div className="mx-auto max-w-6xl px-6">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          >
            {/* Eyebrow */}
            <span className="mb-8 inline-block rounded-full border border-teal/30 bg-teal/5 px-3 py-1 text-xs font-bold tracking-widest text-teal uppercase">
          ...
          >
            ...
            {/* Blockquote */}
            <blockquote
              className="rounded-xl py-4 pr-4 pl-5"
              style={{
                borderLeft: "3px solid #4fcfc0",
                background:
                  "linear-gradient(135deg, rgba(79,207,192,0.06) 0%, rgba(79,207,192,0.01) 100%)",
              }}
            >
              <p className="text-base leading-relaxed font-medium text-text-dim italic">
